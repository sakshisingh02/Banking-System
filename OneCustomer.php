...
$username="root";
$password="";
$con=mysqli_connect("localhost","root","","bank1");
if(!$con){
...
<div class="header">
<h5 style="padding-right: 1rem">Online Service</h5>
</div>
<script>
function myFunction() {
...
<div class="center">  
  <div class="user_details">
    ...
    <h3>Customers Details</h3>
        ...
        {
          $user=$_SESSION['user'];
          $result=mysqli_query($con,"SELECT * FROM detail WHERE Name='$user'");
...
<!-- Make Transcation -->
                ...
                $res = mysqli_query($db, "SELECT * FROM detail WHERE name!='$user'");
